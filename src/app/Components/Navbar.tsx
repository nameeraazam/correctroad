              ...
              <SheetContent>
                ...
                <SheetHeader>
                  <SheetDescription>
                    ...
                    <div className="flex gap-5 px-5 pt-3 ">
                      <Link href={"/cart"}>
                        <span className="h-12 w-20 border-2 hover:border-x-[3px] hover:border-y-[3px] border-black rounded-2xl flex items-center justify-center">
                          Cart
                        </span>
                      </Link>
                      <Link href={"/product-comparision"}>
                        <span className="h-12 w-24 border-2 hover:border-x-[3px] hover:border-y-[3px] border-black rounded-2xl flex items-center justify-center">
                          Comparision
                        </span>
                      </Link>
                      <Link href={"/checkout"}>
